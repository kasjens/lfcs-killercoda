...
**15.** The `man` flag that searches the **body** of every page rather than just
the one-line descriptions. Case matters here: the lowercase version is a
...
Questions 14 and 15 are both in `man man`. The long forms are accepted too, and
reading them is the fastest way to be sure which case does what:
